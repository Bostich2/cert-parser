class SertParserError(Exception):
    """Base domain error."""
...
class InvalidNumberError(SertParserError):
    error_code = "invalid_number"


class UnsupportedCountryError(SertParserError):
...
class CertificateNotFoundError(SertParserError):
...
class SourceUnavailableError(SertParserError):
...
class NoNumbersInPdfError(SertParserError):
...
class PdfReadError(SertParserError):
...
class XlsxReadError(SertParserError):
...
class AmbiguousMatchError(SertParserError):
