...
- **Поиск по товару** (beta) — наименования из буфера (одно на строку) или из столбца A Excel. Приблизительный поиск по формулировке из действующих документов, не по артикулу магазина. Строки в UI идут по очереди.
